...
user/_kpgtbltest：     文件格式 elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  printf("kpgtbltest: main started.\n"); // 1
   ...
   e:	9f650513          	addi	a0,a0,-1546 # a00 <malloc+0x104>
  12:	037000ef          	jal	848 <printf>
  int ret = kpgtbl();
  16:	472000ef          	jal	488 <kpgtbl>
  1a:	84aa                	mv	s1,a0
  printf("kpgtbltest: kpgtbl() returned %d.\n", ret); // 2
  1c:	85aa                	mv	a1,a0
  1e:	00001517          	auipc	a0,0x1
  22:	a0250513          	addi	a0,a0,-1534 # a20 <malloc+0x124>
  26:	023000ef          	jal	848 <printf>
  if(ret < 0){
  2a:	0004cb63          	bltz	s1,40 <main+0x40>
    printf("kpgtbltest: kpgtbl() call explicitly failed.\n"); // 3
  }
  printf("kpgtbltest: main finishing.\n"); // 4
  2e:	00001517          	auipc	a0,0x1
  32:	a4a50513          	addi	a0,a0,-1462 # a78 <malloc+0x17c>
  36:	013000ef          	jal	848 <printf>
  exit(0);
  3a:	4501                	li	a0,0
  3c:	3ac000ef          	jal	3e8 <exit>
    printf("kpgtbltest: kpgtbl() call explicitly failed.\n"); // 3
  40:	00001517          	auipc	a0,0x1
  44:	a0850513          	addi	a0,a0,-1528 # a48 <malloc+0x14c>
  48:	001000ef          	jal	848 <printf>
  4c:	b7cd                	j	2e <main+0x2e>
...
simplesort(void *base, uint nmemb, uint size, int (*compar)(const void *, const void *))
{
 ...
 33c:	76050513          	addi	a0,a0,1888 # a98 <malloc+0x19c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 510:	5bc50513          	addi	a0,a0,1468 # ac8 <digits>
 514:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7a6:	326b8b93          	addi	s7,s7,806 # ac8 <digits>
 ...
 7f4:	2d090913          	addi	s2,s2,720 # ac0 <malloc+0x1c4>
        for(; *s; s++)
